...
- **[RustChain MCP](https://github.com/Scottcjn/rustchain-mcp)** - MCP server for the RustChain Proof-of-Antiquity blockchain: wallet creation, signed RTC micropayments, balance tracking, miner/epoch queries, bounty discovery, BoTTube video publishing, and Beacon agent-to-agent messaging. Gives AI agents their own income rail. Install via `pip install rustchain-mcp`.
